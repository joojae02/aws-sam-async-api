...
```bash
sam-multi-step$ sam build --use-container
```
...
```bash
sam-multi-step$ pip install -r tests/requirements.txt --user
# unit test
sam-multi-step$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-multi-step$ AWS_SAM_STACK_NAME="sam-multi-step" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "sam-multi-step"
```
